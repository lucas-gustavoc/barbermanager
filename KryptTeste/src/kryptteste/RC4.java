...
public class RC4
{
    ...
    public RC4() {
        //String toEncrypt = "12/09/2017|outro|5dias";

        //System.out.println("Encrypting...");
        //byte[] encrypted = encrypt(toEncrypt, "LegendOfZelda");
        
        //String str = getStringFromByteArray(encrypted);
        //System.out.println(str);
        //byte[] ret = getByteArrayFromString(str);
        
        //String decrypted = decrypt(ret, "LegendOfZelda");
